...
OUT_PATH = Path(__file__).parent.parent / "artwork.jpg"
...
def main() -> None:
    ...
    centered_text(1750, "PASTOR'S CONFERENCE", title_font, INK_COLOR)
    centered_text(1950, "AUDIO RECORDINGS", title_font, INK_COLOR)
